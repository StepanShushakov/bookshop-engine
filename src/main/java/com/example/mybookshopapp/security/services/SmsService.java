...
import com.example.mybookshopapp.security.repositories.SmsCodeRepository;
...
//            todo: скопировано, но если возникнет, что указанный код уже существует в базе,
//              то при проверке, будет выходить сообщение, что время жизни истекло
