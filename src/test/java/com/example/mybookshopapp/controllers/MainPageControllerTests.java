...
class MainPageControllerTests {
    ...
    public void correctLoginTest() throws Exception {
        mockMvc.perform(formLogin("/signin").user("email@email.net").password("123456"))
                .andDo(print())
                .andExpect(status().is3xxRedirection())
    ...
    @Test
    @WithUserDetails("email@email.net")
    ...
    public void testSearchQuery() throws Exception {
        mockMvc.perform(get("/search/Sudden"))
                .andDo(print())
                .andExpect(xpath("/html/body/div/div/main/div[2]/div[1]/div[1]/div[2]/strong/a")
